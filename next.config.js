...
const nextConfig = {
  ...
  env: {
    baseURL: 'https://waelportfolio-backend.onrender.com', // Live server
    ...
    latest6Blogs: 'https://waelportfolio-backend.onrender.com/api/blogs?filters[timestampt]&sort[0]=timestamp:asc&',
    ...
    getAllWebinarCategories: 'https://waelportfolio-backend.onrender.com/api/webinar-categories?sort[0]=id%3Aasc&pagination[page]=1&pagination[pageSize]=51&populate=deep,1',
    ...
    latest6Webinars: 'https://waelportfolio-backend.onrender.com/api/webinars?filters[timestampt]&sort[0]=id%3Adesc' ,
    latest6Projects: 'https://waelportfolio-backend.onrender.com/api/blogs?filters[timestampt]&sort[0]=timestamp:asc&',
    latestProject: 'https://waelportfolio-backend.onrender.com/api/projects?sort[0]=createdAt%3Adesc&pagination[page]=1&pagination[pageSize]=1&populate=deep,2',
    getProjectCategories: 'https://waelportfolio-backend.onrender.com/api/project-categories?sort[0]=id%3Aasc&pagination[page]=1&pagination[pageSize]=51&populate=deep,1',
    getAllCategories2:'https://waelportfolio-backend.onrender.com/api/webinar-categories?sort[0]=id%3Aasc&pagination[page]=1&pagination[pageSize]=51&populate=deep,1'
  }
}
