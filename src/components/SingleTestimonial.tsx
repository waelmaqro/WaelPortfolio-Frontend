    ...
    <div key={id} className=' mx-auto px-10 sm:mb-[150px] xxs:mb-[75px] mb-[37.5px] '>
      ...
      <img className="relative left-[50px] md:left-[80px] lg:left-[80px] xl:left-[60px] md:opacity-50 hidden sm:block" src={blockData.leftpattern.data.attributes.url} />
        ...
        <div className=" container-text     " style={{width:'520px'}}>
          <h1 id='code' className="text-slate-700 text-6xl italic mb-0 text-center sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl">“</h1>
        ...
        <img className="relative right-[60px]  lg:right-[80px] xl:right-[80px] md:opacity-50   sm:block hidden md:block" src={blockData.rightpattern.data.attributes.url} />
      </div>
    </div>
  );
};
