...
export default function Project({
            ...
            <SplideTrack className="h-[100%]">
              {blockData.cards.map((cardData: any, index: number) => (
                ...
                >
                  {/* Description */}
                  <div>
                    <h1 className="mx-5 text-navy">{cardData.title}</h1>
                    <p className="mx-5 text-navy">{cardData.category}</p>
                  </div>
                  {/* Desktop Image */}
  ...
  return (
    ...
    >
      {/* Main Content */}
      <h1 className="text-center mx-auto mb-2 text-navy">{blockData.title}</h1>
      <p className="text-center mx-auto sm:w-2/3 sm:mb-15 xxs:mb-12 mb-6 text-navy">
        {blockData.subtitle}
      </p>
