...
export default function ContactUs({ blockData, id }: { blockData: any, id: any }) {
    ...
    const renderSidebar = (sidebar: boolean) => {
        ...
        return (
            <div className='ss:w-[350px] w-[100%] ss:h-[437px] rounded-[50px] bg-navy px-2 ss:py-[76px] py-[38px] ss:mb-0 mb-[60px]'>
                <div className='flex items-center mb-[30px]'>
                    ...
                    <svg className=' sm:w-[52px] w-[32px]' width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="Icon">
                            ...
                            <g id="Group 6">
                                <path id="Vector" d="M34.8846 18H17.1154C15.9471 18 15 18.9514 15 20.125V32.875C15 34.0486 15.9471 35 17.1154 35H34.8846C36.0529 35 37 34.0486 37 32.875V20.125C37 18.9514 36.0529 18 34.8846 18Z" stroke="#313B44" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                <path id="Vector_2" d="M18 21L26 28L34 21" stroke="#313B44" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </g>
                        </g>
                    </svg>
                    <p className='sm:ml-[15px] ml-[8px] p-md text-white'>wael.business@outlook.com</p>
                </div>
                    ...
                    <div className='grid grid-cols-2 gap-4 mx-auto mb-[57px]'>
                        ...
                        <div className='flex-col'>
                            <div className='pb-2 flex'>
                                <p><label className='px-2 text-navy'>Name</label></p>
                                <input
                                    id='name'
                                    type='text'
                                    maxLength={20}
                                    ...
                                    className='invalid:border-red-500 bg-light'
    ...
    const longForm = (
        <div key={id} className='flex justify-center items-center max-w-7xl mx-auto px-10'>
            ...
            <form className='w-[100%]' action="" method="post" onSubmit={handleSubmitLongForm}>
                <div className='mb-[77px] max-w-[634px] text-center flex justify-center items-center mx-auto'>
                    <h1 className='text-navy'>{blockData.title}</h1>
                </div>
                ...
                <div className='flex ss:flex-row flex-col justify-start md:gap-[55px] gap-[25px] text-black'>
                    ...
                    <div className=' grow grid grid-cols-2 gap-4 mx-auto mb-[57px]'>
                        ...
                        <div className='flex-col'>
                            <div className='pb-2 flex'>
                                ...
                                <input
                                    ...
                                    name='name'
                                    onChange={handleChange}
                                    className='invalid:border-red-500 w-[100%] px-2 bg-light'
                                    required />
                            </div>
                            <hr />
                        </div>
                        ...
                        <div className='flex-col'>
                            <div className='pb-2 flex'>
                                <p><label className='px-2 text-navy'>Email</label></p>
                                <input
                                    id='email'
                                    type='email'
                                    name='email'
                                    onChange={handleChange}
                                    pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"
                                    className='invalid:border-red-500 w-[100%] px-2 bg-transparent'
                                    required />
                            </div>
                            <hr />
                        </div>
                        ...
                        <div className='flex-col mt-[57px]'>
                            <div className='pb-2 flex'>
                                <p><label className='px-2 text-navy'>Subject</label></p>
                                <input
                                    id='subject'
                                    type='text'
                                    name='subject'
                        ...
                        <div className='flex-col mt-[57px]'>
                            <div className='pb-2 flex'>
                                <p><label className='px-2 text-navy'>Phone</label></p>
                                <input
                                    id='phone'
                                    type='tel'
                                    maxLength={12}
                        ...
                        {/* Body */}
                        <div className='col-span-2 px-1 mt-[57px]'>
                            <p><label className='py-2 text-navy'>Hello, I am Interested in..</label></p>
                            <textarea
                                id='message'
                                name='message'
                                rows={5}
                                ...
                                maxLength={300}
                                onChange={handleChange}
                                className='resize-none p-2 font-Jost text-[22px] text-[#4D5053] w-[100%] bg-transparent'
                                required />
                            <hr />
                        </div>
                        <div className='col-span-2 flex flex-col items-end mt-[77px]'>
                            <ReCAPTCHA
                                ...
                                onChange={onReCAPTCHAChange}
                            />
                            <button type='submit' className={`text-white max-w-[220px] font-Jost flex justify-center items-center rounded-[18px] bg-navy hover:bg-[#434950] 
                                py-[26px] px-[37px] xs:text-[18px] xxs:text-[14px] xxxs:text-[14px]`}>
                                {blockData.button.buttonLabel}
                                <Image className='ml-[10px]' src={blockData.button.icon.data.attributes.url} width={20} height={20} alt={blockData.button.icon.data.attributes.alternativeText} loading='lazy' />
                            </button>
