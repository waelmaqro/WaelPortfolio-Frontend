...
export default function ContactUs({ blockData, id }: { blockData: any, id: any }) {
    ...
    const renderSidebar = (sidebar: boolean) => {
        ...
        return (
            <div className='ss:w-[350px] w-[100%] ss:h-[437px] rounded-[50px] bg-navy px-8 ss:py-[76px] py-[38px] ss:mb-0 mb-[60px]'>
                <div className='flex items-center mb-[30px]'>
                    ...
                    <p className='sm:ml-[15px] ml-[8px] p-md text-white'>info@yourdomain.com</p>
                </div>
                ...
                <div className='flex items-center mb-[30px]'>
                    ...
                    <p className='sm:ml-[15px] ml-[8px] p-md text-white'>+1 (378) 400-1234</p>
                </div>
